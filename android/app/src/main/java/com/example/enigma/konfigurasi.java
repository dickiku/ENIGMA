...
public class konfigurasi {
    ...
    public static final String URL_ADD_MHS="http://192.168.100.8/Enigma/database/addMaha.php";
    public static final String URL_LOGIN_MHS="http://192.168.100.8/Enigma/database/loginMaha.php";
    public static final String URL_ADD_DSN="http://192.168.100.8/Enigma/database/addDosen.php";
    public static final String URL_LOGIN_DSN="http://192.168.100.8/Enigma/database/loginDosen.php";
    public static final String URL_Absen="http://192.168.100.8/Enigma/database/Absen.php";
    public static final String URL_GETDATA_DSN="http://192.168.100.8/Enigma/database/dataDosen.php";
    public static final String URL_Qr_nim="http://192.168.100.8/Enigma/database/temp/";
